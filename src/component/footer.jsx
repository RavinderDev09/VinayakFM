      ...
      <div className="footer-container">
        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            ...
            <div className="social-links">
              <button 
                ...
                onClick={() => openSocialLink('https://www.linkedin.com/company/vinayak-facility-management-services')}
                aria-label="LinkedIn"
              >
              ...
              <button 
                className="social-link" 
                onClick={() => openSocialLink('https://twitter.com/yourusername')}
                aria-label="Twitter"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button 
                className="social-link" 
                onClick={() => openSocialLink('https://instagram.com/yourusername')}
          ...
          <div className="footer-links">
            ...
            <div className="link-group">
              <h4>Support</h4>
              <ul>
                <li><button onClick={() => scrollToSection('help')}>Help Center</button></li>
                <li><button onClick={() => scrollToSection('privacy')}>Privacy Policy</button></li>
                <li><button onClick={() => scrollToSection('terms')}>Terms of Service</button></li>
                <li><button onClick={() => scrollToSection('cookies')}>Cookie Policy</button></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        {/* <div className="developer-section">
          <div className="developer-info">
            ...
            <div className="developer-details">
              <h4>Developed with ❤️ by Ravinder kumar</h4>
              <p>Full Stack Developer & UI/UX Enthusiast</p>
              <div className="developer-actions">
                <button 
                  className="contact-btn primary"
                  onClick={() => openSocialLink('https://www.linkedin.com/in/ravinder-kumar-425522244')}
                >
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {currentYear} Vinayak Facility Management. All rights reserved.</p>
          </div>
          <div className="footer-legal">
            <button onClick={() => scrollToSection('privacy')}>Privacy Policy</button>
            <button onClick={() => scrollToSection('terms')}>Terms of Service</button>
            <button onClick={() => scrollToSection('cookies')}>Cookie Policy</button>
          </div>
        </div>
      </div>
    </footer>
